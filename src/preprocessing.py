...
RAW_CSV = "data/results_raw.csv"
OUT_FULL = "data/results_full.csv"
OUT_10Y = "data/results_last_10yrs.csv"
OUT_5Y = "data/results_last_5yrs.csv"
...
def main():
    ...
    df_10y.to_csv(OUT_10Y, index=False)

    # last 5 years
    df_5y = filter_by_cutoff(df_clean, CUTOFF_5Y)
    df_5y.to_csv(OUT_5Y, index=False)
